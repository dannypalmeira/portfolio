        ...
        <header>
            <nav className={styles.navegacao}>
                ...
                <div className={styles.socials}>
                    <a target="_blank" href="mailto:danny.palmeira.ux@gmail.com" rel="noreferrer">
                        <title className={styles.title}>Mail me!</title>{" "}
                        <svg
                            width="22"
                            height="22"
                            viewBox="0 0 24 24"
                    ...
                    <a target="_blank" href="https://github.com/dannypalmeira" rel="noreferrer">
                        <svg
                            width="22"
                            height="22"
                            viewBox="0 0 20 22"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                            <title class="ico-white">Link Icon to github profile</title>
                    ...
                    <a target="_blank" href="https://www.linkedin.com/in/dannypalmeira/" rel="noreferrer">
                        <title class="ico-white">Link icon to linkedin profile</title>{" "}
